...
var file_reservation_service_proto_rawDesc = []byte{
	...
	0x6c, 0x52, 0x65, 0x6a, 0x65, 0x63, 0x74, 0x65, 0x64, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61,
	...
	0x63, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x32, 0xc1,
	...
	0x74, 0x41, 0x6c, 0x6c, 0x52, 0x65, 0x6a, 0x65, 0x63, 0x74, 0x65, 0x64, 0x52, 0x65, 0x73, 0x65,
	...
	0x6e, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x52, 0x65, 0x6a, 0x65, 0x63, 0x74, 0x65, 0x64,
	...
	0x2f, 0x72, 0x65, 0x6a, 0x65, 0x63, 0x74, 0x65, 0x64, 0x12, 0x85, 0x01, 0x0a, 0x11, 0x52, 0x65,
	...
	0x73, 0x74, 0x42, 0x14, 0x5a, 0x12, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x72, 0x65, 0x73,
...
var file_reservation_service_proto_goTypes = []interface{}{
	...
	(*GetAllRejectedReservationsResponse)(nil), // 9: reservation.GetAllRejectedReservationsResponse
...
var file_reservation_service_proto_depIdxs = []int32{
	...
	18, // 4: reservation.GetAllRejectedReservationsResponse.reservation:type_name -> reservation.Reservation
	...
	0,  // 19: reservation.ReservationService.GetAllRejectedReservations:input_type -> reservation.EmptyRequest
	...
	4,  // 24: reservation.ReservationService.CreateAvailability:output_type -> reservation.CreateAvailabilityResponse
	12, // 25: reservation.ReservationService.GetAllMy:output_type -> reservation.GetAllMyResponse
	11, // 26: reservation.ReservationService.UpdatePriceAndDate:output_type -> reservation.UpdateRequest
	10, // 27: reservation.ReservationService.CreateReservation:output_type -> reservation.CreateReservationRequest
	0,  // 28: reservation.ReservationService.CreateAvailabilityBase:output_type -> reservation.EmptyRequest
	8,  // 29: reservation.ReservationService.GetAllPendingReservations:output_type -> reservation.GetAllPendingReservationsResponse
	9,  // 30: reservation.ReservationService.GetAllRejectedReservations:output_type -> reservation.GetAllRejectedReservationsResponse
	6,  // 31: reservation.ReservationService.RejectReservation:output_type -> reservation.RejectReservationResponse
	6,  // 32: reservation.ReservationService.AcceptReservation:output_type -> reservation.RejectReservationResponse
	6,  // 33: reservation.ReservationService.CancelReservation:output_type -> reservation.RejectReservationResponse
	1,  // 34: reservation.ReservationService.GetAllReservationsForGuest:output_type -> reservation.GetAllReservationsForGuestResponse
