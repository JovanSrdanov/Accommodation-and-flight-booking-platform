...
var file_reservation_service_proto_rawDesc = []byte{
	...
	0x32, 0xc0, 0x0d, 0x0a, 0x12, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x1e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x18, 0x22, 0x13, 0x2f, 0x61, 0x70, 0x69, 0x2d, 0x31, 0x2f,
	...
	0x75, 0x65, 0x73, 0x74, 0x22, 0x1e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x18, 0x1a, 0x13, 0x2f, 0x61,
	0x70, 0x69, 0x2d, 0x31, 0x2f, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74,
	0x79, 0x3a, 0x01, 0x2a, 0x12, 0x80, 0x01, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52,
	...
	0x22, 0x12, 0x2f, 0x61, 0x70, 0x69, 0x2d, 0x31, 0x2f, 0x72, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x3a, 0x01, 0x2a, 0x12, 0x84, 0x01, 0x0a, 0x16, 0x43, 0x72, 0x65, 0x61,
	...
	0x1d, 0x22, 0x18, 0x2f, 0x61, 0x70, 0x69, 0x2d, 0x31, 0x2f, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61,
	0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x2f, 0x62, 0x61, 0x73, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0x8a,
	...
	0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64, 0x52, 0x65,
	...
	0x6f, 0x6e, 0x2f, 0x61, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64, 0x12, 0x85, 0x01, 0x0a, 0x11,
	0x52, 0x65, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f,
	...
	0x69, 0x64, 0x7d, 0x12, 0x8e, 0x01, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x52, 0x65,
	0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x46, 0x6f, 0x72, 0x47, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x19, 0x2e, 0x72, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x72, 0x47, 0x75, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x24,
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1e, 0x12, 0x1c, 0x2f, 0x61, 0x70, 0x69, 0x2d, 0x31, 0x2f, 0x72,
	0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x61, 0x6c, 0x6c, 0x2f, 0x67,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x7f, 0x0a, 0x1a, 0x47, 0x75, 0x65, 0x73, 0x74, 0x48, 0x61, 0x73,
	0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f,
...
var file_reservation_service_proto_depIdxs = []int32{
	...
	4,  // 26: reservation.ReservationService.CreateAvailability:output_type -> reservation.CreateAvailabilityResponse
	12, // 27: reservation.ReservationService.GetAllMy:output_type -> reservation.GetAllMyResponse
	11, // 28: reservation.ReservationService.UpdatePriceAndDate:output_type -> reservation.UpdateRequest
	10, // 29: reservation.ReservationService.CreateReservation:output_type -> reservation.CreateReservationRequest
	0,  // 30: reservation.ReservationService.CreateAvailabilityBase:output_type -> reservation.EmptyRequest
	8,  // 31: reservation.ReservationService.GetAllPendingReservations:output_type -> reservation.GetAllPendingReservationsResponse
	9,  // 32: reservation.ReservationService.GetAllAcceptedReservations:output_type -> reservation.GetAllAcceptedReservationsResponse
	6,  // 33: reservation.ReservationService.RejectReservation:output_type -> reservation.RejectReservationResponse
	6,  // 34: reservation.ReservationService.AcceptReservation:output_type -> reservation.RejectReservationResponse
	6,  // 35: reservation.ReservationService.CancelReservation:output_type -> reservation.RejectReservationResponse
	1,  // 36: reservation.ReservationService.GetAllReservationsForGuest:output_type -> reservation.GetAllReservationsForGuestResponse
	21, // 37: reservation.ReservationService.GuestHasActiveReservations:output_type -> reservation.GuestHasActiveReservationsResponse
	23, // 38: reservation.ReservationService.HostHasActiveReservations:output_type -> reservation.HostHasActiveReservationsResponse
