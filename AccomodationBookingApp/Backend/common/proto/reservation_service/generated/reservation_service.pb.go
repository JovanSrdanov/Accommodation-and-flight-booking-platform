...
var file_reservation_service_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x5f, 0x0a, 0x21, 0x47, 0x65, 0x74, 0x41,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x67, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x22, 0x81, 0x01, 0x0a,
...
var file_reservation_service_proto_goTypes = []interface{}{
	...
	(*AvailabilityRequest)(nil),                                           // 23: reservation.AvailabilityRequest
	(*GuestHasActiveReservationsRequest)(nil),                             // 24: reservation.GuestHasActiveReservationsRequest
	(*GuestHasActiveReservationsResponse)(nil),                            // 25: reservation.GuestHasActiveReservationsResponse
	(*HostHasActiveReservationsRequest)(nil),                              // 26: reservation.HostHasActiveReservationsRequest
	(*HostHasActiveReservationsResponse)(nil),                             // 27: reservation.HostHasActiveReservationsResponse
	(*DeleteAvailabilitiesAndReservationsByAccommodationIdsRequest)(nil),  // 28: reservation.DeleteAvailabilitiesAndReservationsByAccommodationIdsRequest
	(*DeleteAvailabilitiesAndReservationsByAccommodationIdsResponse)(nil), // 29: reservation.DeleteAvailabilitiesAndReservationsByAccommodationIdsResponse
}
var file_reservation_service_proto_depIdxs = []int32{
	...
	23, // 5: reservation.CreateAvailabilityRequest.availability:type_name -> reservation.AvailabilityRequest
	22, // 6: reservation.GetAllPendingReservationsResponse.reservation:type_name -> reservation.Reservation
	...
	20, // 15: reservation.AvailabilityRequest.priceWithDate:type_name -> reservation.PriceWithDate
	7,  // 16: reservation.ReservationService.CreateAvailability:input_type -> reservation.CreateAvailabilityRequest
	0,  // 17: reservation.ReservationService.GetAllMy:input_type -> reservation.EmptyRequest
	15, // 18: reservation.ReservationService.UpdatePriceAndDate:input_type -> reservation.UpdateRequest
	14, // 19: reservation.ReservationService.CreateReservation:input_type -> reservation.CreateReservationRequest
	6,  // 20: reservation.ReservationService.CreateAvailabilityBase:input_type -> reservation.CreateAvailabilityBaseRequest
	0,  // 21: reservation.ReservationService.GetAllPendingReservations:input_type -> reservation.EmptyRequest
	0,  // 22: reservation.ReservationService.GetAllAcceptedReservations:input_type -> reservation.EmptyRequest
	9,  // 23: reservation.ReservationService.RejectReservation:input_type -> reservation.ChangeStatusRequest
	9,  // 24: reservation.ReservationService.AcceptReservation:input_type -> reservation.ChangeStatusRequest
	9,  // 25: reservation.ReservationService.CancelReservation:input_type -> reservation.ChangeStatusRequest
	0,  // 26: reservation.ReservationService.GetAllReservationsForGuest:input_type -> reservation.EmptyRequest
	1,  // 27: reservation.ReservationService.SearchAccommodation:input_type -> reservation.SearchRequest
	24, // 28: reservation.ReservationService.GuestHasActiveReservations:input_type -> reservation.GuestHasActiveReservationsRequest
	26, // 29: reservation.ReservationService.HostHasActiveReservations:input_type -> reservation.HostHasActiveReservationsRequest
	28, // 30: reservation.ReservationService.DeleteAvailabilitiesAndReservationsByAccommodationIds:input_type -> reservation.DeleteAvailabilitiesAndReservationsByAccommodationIdsRequest
	...
	25, // 43: reservation.ReservationService.GuestHasActiveReservations:output_type -> reservation.GuestHasActiveReservationsResponse
	27, // 44: reservation.ReservationService.HostHasActiveReservations:output_type -> reservation.HostHasActiveReservationsResponse
	29, // 45: reservation.ReservationService.DeleteAvailabilitiesAndReservationsByAccommodationIds:output_type -> reservation.DeleteAvailabilitiesAndReservationsByAccommodationIdsResponse
