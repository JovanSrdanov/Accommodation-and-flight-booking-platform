...
func (c *authorizationServiceClient) CheckIfDeleted(ctx context.Context, in *CheckIfDeletedRequest, opts ...grpc.CallOption) (*CheckIfDeletedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/authorization.AuthorizationService/CheckIfDeleted", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authorizationServiceClient) ChangeUsername(ctx context.Context, in *ChangeUsernameRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/authorization.AuthorizationService/ChangeUsername", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthorizationService_CheckIfDeleted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/authorization.AuthorizationService/CheckIfDeleted",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthorizationService_ChangeUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/authorization.AuthorizationService/ChangeUsername",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
