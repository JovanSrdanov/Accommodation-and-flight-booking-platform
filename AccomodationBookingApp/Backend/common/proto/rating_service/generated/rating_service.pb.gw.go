...
func RegisterRatingServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RatingServiceServer) error {
	...
	mux.Handle("POST", pattern_RatingService_RateAccommodation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/reservation.RatingService/RateAccommodation", runtime.WithHTTPPathPattern("/api-1/rate/accommodation"))
		if err != nil {
...
func RegisterRatingServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RatingServiceClient) error {
	...
	mux.Handle("POST", pattern_RatingService_RateAccommodation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/reservation.RatingService/RateAccommodation", runtime.WithHTTPPathPattern("/api-1/rate/accommodation"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_RatingService_RateAccommodation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api-1", "rate", "accommodation"}, ""))
)
