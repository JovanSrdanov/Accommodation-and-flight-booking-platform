...
func (c *accommodationServiceClient) GetById(ctx context.Context, in *GetByIdRequest, opts ...grpc.CallOption) (*GetByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/accommodation.AccommodationService/GetById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accommodationServiceClient) GetAllMy(ctx context.Context, in *GetMyRequest, opts ...grpc.CallOption) (*GetAllResponse, error) {
	out := new(GetAllResponse)
	err := c.cc.Invoke(ctx, "/accommodation.AccommodationService/GetAllMy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accommodationServiceClient) DeleteByHostId(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	out := new(DeleteResponse)
	err := c.cc.Invoke(ctx, "/accommodation.AccommodationService/DeleteByHostId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accommodationServiceClient) GetAmenities(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*GetAmenitiesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/accommodation.AccommodationService/GetAmenities", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accommodationServiceClient) DeleteAllByHostId(ctx context.Context, in *DeleteAllByHostIdRequest, opts ...grpc.CallOption) (*DeleteAllByHostIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/accommodation.AccommodationService/DeleteAllByHostId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AccommodationService_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/accommodation.AccommodationService/GetById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccommodationService_GetAllMy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/accommodation.AccommodationService/GetAllMy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccommodationService_DeleteByHostId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/accommodation.AccommodationService/DeleteByHostId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccommodationService_GetAmenities_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/accommodation.AccommodationService/GetAmenities",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccommodationService_DeleteAllByHostId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AccommodationServiceServer).DeleteAllByHostId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/accommodation.AccommodationService/DeleteAllByHostId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccommodationServiceServer).DeleteAllByHostId(ctx, req.(*DeleteAllByHostIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccommodationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AccommodationService_DeleteAllByHostId_Handler,
		},
	},
