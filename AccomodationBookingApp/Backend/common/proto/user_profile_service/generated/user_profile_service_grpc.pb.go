...
type UserProfileServiceClient interface {
	...
	// Internal usage only
	DeleteUserProfile(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error)
...
func (c *userProfileServiceClient) DeleteUserProfile(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	out := new(DeleteResponse)
	err := c.cc.Invoke(ctx, "/user_profile.UserProfileService/DeleteUserProfile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserProfileServiceServer interface {
	...
	// Internal usage only
	DeleteUserProfile(context.Context, *DeleteRequest) (*DeleteResponse, error)
...
func (UnimplementedUserProfileServiceServer) DeleteUserProfile(context.Context, *DeleteRequest) (*DeleteResponse, error) {
...
func _UserProfileService_DeleteUserProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_profile.UserProfileService/DeleteUserProfile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserProfileServiceServer).DeleteUserProfile(ctx, req.(*DeleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
